...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-card rounded-xl shadow-lg border border-primary/10", className)}
      classNames={{
        months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center",
        caption_label: "text-sm font-black uppercase tracking-tight text-primary",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border-primary/20 hover:bg-primary/5 transition-colors"
        ),
        ...
        head_row: "flex mb-2",
        head_cell:
          "text-muted-foreground rounded-md w-9 font-black uppercase text-[10px]",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-bold aria-selected:opacity-100 hover:bg-primary/10 hover:text-primary transition-all"
        ),
